...
public class TogglePlatform : MonoBehaviour {
	...
	void Start () {
		...
		if (isActive == true) {
			...
			myColliderTop.sharedMaterial = Resources.Load ("Physical Material/Ground") as PhysicsMaterial2D;
			...
			myColliderBottom.sharedMaterial = Resources.Load ("Physical Material/Ground") as PhysicsMaterial2D;
